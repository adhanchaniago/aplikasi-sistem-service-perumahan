...
<div class="card">
	...
	<form action="edit_user.php" method="post" class="col-md-7">
		...
		<input name="id_member" type="hidden" class="form-control"  id="id_member" value="<?php echo $b['id_member']?>">
					...
					<td><input name="nama" type="text" class="form-control" placeholder="jab " id="jab" value="<?php echo $b['jabatan']?>" readonly>
					</td>
					</tr>
					<tr>
					<td>
					<label>Jabatan</label></td>
					<td><input name="nama" type="text" class="form-control" placeholder="masjab " id="masjab" value="<?php echo $b['masa_jabatan']?>" readonly>
					</td>
					</tr>
					<tr>
					<td>
