...
<body>
    ...
    -->
            <div class="logo">
                <a href="profile_pengurus.php?user=<?php echo $_SESSION['uname']?>" class="simple-text">
                    Service Perumahan
                </a>
            </div>
			...
			?>		
                ...
                <ul class="nav">
                    <li class="active">
                        <a class="wave-effects" href="profile_pengurus.php?user=<?php echo $_SESSION['uname']?>">
                            <i class="material-icons">dashboard</i>
                            <p>Dashboard</p>
                        </a>
                    </li>
                    <li class="active">
                        <a class="wave-effects" href="tambah_penghuni.php?user=<?php echo $_SESSION['uname']?>">
                            <i class="material-icons">person_add</i>
                            <p>Tambah Penghuni</p>
                        </a>
                    </li >
					<li class="active">
                        <a class="wave-effects" href="data_penghuni.php?user=<?php echo $_SESSION['uname']?>">
                                <i class="material-icons">visibility</i>
								<p>Lihat Data Penghuni</p>
						</a>                            
