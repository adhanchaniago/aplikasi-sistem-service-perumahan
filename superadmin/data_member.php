...
error_reporting(0);
 ...
 <h3 class="col-md-4">Data Semua Member</h3>
...
<?php 
	...
	$peg=mysql_query("select * from member limit $start, $per_hal");
...
<?php	
  ...
  ?>
		<td align="center">
				...
				<a href="profile_member.php?id_member=<?php echo $b->id_member; ?>">Lihat Profile&nbsp;&nbsp;<i class="fa fa-arrow-circle-right"></i></a>
			<div>
			</td>
