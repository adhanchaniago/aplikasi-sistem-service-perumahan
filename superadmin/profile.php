...
include 'header.php';
?>
<h3 class="col-md-4">Data Pengurus</h3>
<div class="content">
...
<div class="card">
    <div class="card-header" data-background-color="purple">
        <h4 class="title">Profile Pengurus</h4>
        <a href="data_pengurus.php"><i class="material-icons">navigate_before</i>  Kembali</a>
    </div>
	...
	<?php 
		...
		?>
	<form action="buat_user.php" method="post" class="col-md-4">
